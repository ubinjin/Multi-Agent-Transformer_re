...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        elif self.algorithm_name == "mat_recurrent":
            from mat.algorithms.mat.algorithm.mat_recurrent import MultiAgentTransformer as MAT
        elif self.algorithm_name == "mat_gat":
            from mat.algorithms.mat.algorithm.mat_gat import MultiAgentTransformer as MAT
        else:
